...
export const FastMinuteSpeedLimiter = speedLimiter({ windowMs: 60000, delayAfter: 16, delayMs: 1000 })
...
export const FastSecondSpeedLimiter = speedLimiter({ windowMs: 1000, delayAfter: 2, delayMs: 1000 })
